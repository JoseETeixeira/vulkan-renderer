...
/// @brief Check for collision between a vertex and a cube.
/// @param cube The cube to check for
/// @param pos The start position of the ray
/// @param dir The direction vector of the ray
/// @return The vector of the intersection point, `std::nullopt` otherwise
