...
std::shared_ptr<Cube> create_random_world(int max_deep) {
    ...
    std::function<void(std::shared_ptr<Cube>, int)> populate_cube;
    populate_cube = [&](std::shared_ptr<Cube> parent, int depth) {
